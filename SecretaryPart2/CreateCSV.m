...
NSString *selectedButton = nil;
NSArray *sortedArray = nil;
AttendanceObject *CSVrecord;

- (void)viewDidLoad
{
    [super viewDidLoad];
    CSVrecord = [meetingList objectAtIndex:theRowNumber];
...
-(void)createCSV {
    ...
    for (int i=0; i< [sortedArray count]; i++) {
        ...
        NSString *status;
        NSString *epochTime = [NSString stringWithFormat:@"%f", CSVrecord.time];
